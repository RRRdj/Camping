...
class AlarmManageScreen extends StatelessWidget {
                ...
                trailing: Row(
                  ...
                  children: [
                    IconButton(
                      ...
                      onPressed: () => _editAlarm(context, user.uid, docId, date),
                    ),
                    IconButton(
  ...
  Future<void> _editAlarm(BuildContext context, String uid, String docId, DateTime oldDate) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('알림 날짜가 수정되었습니다.')),
    );
  }
}
