...
""");
    ...
    return """
<!DOCTYPE html><html><head><meta charset='utf-8'><meta http-equiv='Content-Security-Policy' content='upgrade-insecure-requests'>
<style>html,body,#map{margin:0;padding:0;width:100%;height:100%}</style>
<script>(function(){const _old=document.write.bind(document);document.write=s=>_old(s.replace(/http:\/\/t1\.daumcdn\.net/g,'https://t1.daumcdn.net'));})();</script>
