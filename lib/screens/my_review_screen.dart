...
class _MyReviewsScreenState extends State<MyReviewsScreen> {
  ...
  Future<void> _edit(
                      ...
                      children: [
                        ...
                        if (currentUrls.isNotEmpty) ...[
                          const Align(
                            ...
                            child: Text('기존 사진', style: TextStyle(
    ...
    if (result == true) {
      // TODO: repository에 이미지 sync 기능 구현 필요
      final removedUrls = oldImageUrls.where((url) =>
      !currentUrls.contains(url)).toList();
      ...
      body: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
        ...
        builder: (ctx, snap) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (_, i) {
              final m = docs[i].data();
              final imageUrls = (m['imageUrls'] as List<dynamic>?)?.cast<String>() ?? [];
